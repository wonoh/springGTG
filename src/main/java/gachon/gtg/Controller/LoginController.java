...
public class LoginController {
	...
	public String callback(Model model, @RequestParam String code, @RequestParam String state, HttpSession session)
	    ...
	    JSONObject jo=(JSONObject)jp.parse(apiResult);
	    JSONObject data=(JSONObject)jo.get("response");
	    name=(String) data.get("name");
	    profile_image=(String)data.get("profile_image");
	    ...
	    boolean check=userDAO.checkUser(id);
	    if(check==true) {
	    	return "create";
	    }
	    else {
